...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a  href="../main/main.do" class="navbar-brand d-inline-flex" href="index.html"><img class="d-inline-block" src="../img/gallery/logo.svg" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">foodwaGon</span></a>
